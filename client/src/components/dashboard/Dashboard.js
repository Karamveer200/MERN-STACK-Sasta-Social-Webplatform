...
const Dashboard = ({getCurrentProfile, deleteAccount, auth:{user}, profile:{profile, loading}}) => {
    ...
    return loading && profile===null? <Spinner />:<div className="">
    <section className="">
            <Fragment>
                <div className='bg-primary p-1 round-btn-only'>
                    <h2>    Message from Karamveer-</h2>
                    <h3>    Thanks for your visit. Please do leave a review by uploading a post</h3>
                ...
                {profile !== null?(
                    ...
                    <Link to="/create-profile" className="btn btn-gradient round-btn-only my-1">Create Profile</Link>
                    </Fragment>)}
            </Fragment>
        </section>
    </div>
